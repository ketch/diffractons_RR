...
def plot_p(frame,file_prefix='claw_p',path='./_output/_p',plot_slices=True,plot_pcolor=True,slices_limits=None,xshift=0.0,name=''):
    ...
    if plot_pcolor:
        ...
        pl.savefig('./_plots_to_paper/many_diffractons_pcolor.png')
        #pl.show()                            
        pl.close()
    if plot_slices:
        pl.figure(figsize=(8,3))
        ...
        pl.savefig('./_plots_to_paper/many_diffractons_slices.eps')
        pl.close()
...
if __name__== "__main__":
    ...
    print('**********************')
    print('Plotting p ...')
    plot_p(frame=1470,plot_pcolor=True,xshift=1800)
