...
def plot_p(frame,zlim=[0.,1.]):
    ...
    pl.savefig('./_plots_to_animation/pcolor/counter-interaction_'+str_frame+'.png')
    pl.close()
    # Plot slices
    pl.figure(figsize=(8,3))
    ...
    pl.savefig('./_plots_to_animation/slices/counter-interaction_'+str_frame+'_slices.eps')
    pl.close()
